...
import com.soft.api.service.lis.zigong.DepatmentLISImpl;
import com.soft.api.service.lis.zigong.EmployeeLISImpl;
...
public class ZIGONGLISInterfaceImpl implements IZIGONGLISInterface {

    @Autowired
    private DepatmentLISImpl depatment;

    @Autowired
    private EmployeeLISImpl employee;
