 ...
 **/
@Configuration
@MapperScan(basePackages = { "com.soft.api.mapper.portal" }, sqlSessionTemplateRef = "sqlSessionTemplateDBPortal",nameGenerator = UniqueNameGenerator.class)
public class PortalDataSourceConfig {

    @Bean(name = "dataSourceDBPortal")
    public DataSource dataSourceCar(PortalDBConfig dbConfig) throws SQLException {
...
//        druid.setMaxPoolPreparedStatementPerConnectionSize(maxPoolPreparedStatementPerConnectionSize);
    ...
    @Bean(name = "sqlSessionFactoryDBPortal")
    public SqlSessionFactory sqlSessionFactoryCar(@Qualifier("dataSourceDBPortal") DataSource dataSource) throws Exception {
        SqlSessionFactoryBean bean = new SqlSessionFactoryBean();
        bean.setDataSource(dataSource);
        bean.setMapperLocations(new
                PathMatchingResourcePatternResolver().getResources("classpath:mapper/portal/**/*.xml"));
        return bean.getObject();
    }

    @Bean(name = "sqlSessionTemplateDBPortal")
    public SqlSessionTemplate sqlSessionTemplateCar(
            @Qualifier("sqlSessionFactoryDBPortal") SqlSessionFactory sqlSessionFactory) throws Exception {
