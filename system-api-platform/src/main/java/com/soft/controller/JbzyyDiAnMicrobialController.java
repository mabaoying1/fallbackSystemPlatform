...
import com.soft.service.JbzyyDiAnMicrobialService;
 ...
 */
@Controller
public class JbzyyDiAnMicrobialController {
    @Autowired
    private JbzyyDiAnMicrobialService jbzyyDiAnMicrobialService;
    ...
    public String DiAnMicrobial(String url,String clientID, String clientGUID,String method)   {
        ...
        try {
            ...
            try {
                String resultMsg = jbzyyDiAnMicrobialService.microbial(url,clientID,clientGUID,method);
            ...
            e.printStackTrace();
            return "DiAnMicrobial微生物接口异常【"+e.getMessage()+"】";
        }
    }
